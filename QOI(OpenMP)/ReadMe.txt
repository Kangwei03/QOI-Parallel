1. Open C:\..\QOI(OpenMP)\DSPC\x64\Debug
...
5. Open Command Prompt and cd to C:\..\QOI(OpenMP)\DSPC\x64\Debug

6. Enter command "QOI.exe [encode|decode] bigImages output [number of threads]"

8. After done running, open C:\..\QOI(OpenMP)\DSPC\x64\Debug, and get the performance csv file

9. Open Google colab or anything IDE with python

10. Open C:\..\QOI(OpenMP)\DSPC\x64\Debug, find the graph.txt and copy the code inside to IDE / Google colab
